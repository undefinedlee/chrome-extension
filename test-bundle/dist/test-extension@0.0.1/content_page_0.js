define("test-extension@0.0.1/content_page_0.js", function(require){
    return [
        		// content_page_0.js
        		function(__inner_require__, exports, module){
        			...
        			var pages = [];
        			pages.push(injectRequire("test-extension@0.0.1/content_script_0.js", true));
        			(0, _pageBackground2.default)([_pageLoader2.default, _pageBabelHelpers2.default].concat(pages));
        		}
    ];
});
require("test-extension@0.0.1/content_page_0.js");