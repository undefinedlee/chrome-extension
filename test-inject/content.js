...
var MESSAGE_DOM_ID = "__$_Kraken_message_dom_$__";
...
var bridge = function(){
    ...
    messageDom.addEventListener("script", function(){
        ...
        (new Function("return " + commandContent))()();
    });
...
injectScript(function(){
    ...
    console.log(document.getElementById("_j_index_search_tab").getElementsByTagName("li")[2]);
    console.log(document.getElementById("_j_index_search_input_mdd"));
    document.getElementById("_j_index_search_tab").getElementsByTagName("li")[2].click();
    document.getElementById("_j_index_search_input_mdd").value = "爱尔兰";
    document.getElementById("_j_index_search_btn_mdd").click();
});
